...
getElementById("picture").innerHTML = chico[current].picture;
getElementById("caption").innerHTML = chico[current].description;
getElementById("source").innerHTML = chico[current].from;
} //to write this is the lo
